...
IAM.MAI exists to answer one question only:
...
IAM.MAI applies **only** to transitions that are **irreversible by definition**.
...
- the prior state becomes **historical**,
- the new state becomes **standing**,
- reversibility is permanently lost,
- downstream systems may rely on the result.

IAM.MAI FINALIZE is itself **irreversible**.
