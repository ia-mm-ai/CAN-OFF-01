# CANON - The Presence Stack Constitutional Specification (0 1)
...
## I. Canonical Law (Binding)

1. **No reasoning without admissibility.**  
   If BPL fails, the system halts.

2. **No action without Presence.**  
   All decisions must pass through HOLD.

3. **No irreversibility without legitimacy.**  
...
These laws override all local logic.
